...
@AndroidEntryPoint
class ForgotPasswordOptionActivity :
    BaseActivity<AuthViewModel, ActivityForgotPasswordOptionBinding>() {

    private val TAG = "ForgotPasswordOptionActivity"

    override fun getViewBinding(): ActivityForgotPasswordOptionBinding =
        ActivityForgotPasswordOptionBinding.inflate(layoutInflater)
