package com.mxb.app.utils.otp.view
...
import com.mxb.app.utils.otp.style.KeyboardType
...
class OtpView : FrameLayout {
    ...
    private fun setAttributes(context: Context, attrs: AttributeSet?) {
        ...
        for (i in 0 until N) {
            ...
            when (attr) {
                ...
                R.styleable.OtpView_digitsOtp -> {
                    digits = a.getInt(R.styleable.OtpView_digitsOtp, 6)
                }
                ...
                R.styleable.OtpView_textSizeOtp -> {
                    fontSize = a.getInt(R.styleable.OtpView_textSizeOtp, 22).toFloat()
                }

                R.styleable.OtpView_textColorOtp -> {
                    textColor = Color(a.getColor(R.styleable.OtpView_textColorOtp, -1))
                }
                ...
                R.styleable.OtpView_fontFamilyOtp -> {
                    val textStyle = a.getInt(R.styleable.OtpView_fontFamilyOtp, 2)
                    val typeFace = getTypeface(context, textStyle)
    ...
    private fun refresh() {
        ...
        otpView.layoutDirection = LAYOUT_DIRECTION_LTR
    }
