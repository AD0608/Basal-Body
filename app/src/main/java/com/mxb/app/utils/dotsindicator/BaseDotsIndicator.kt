package com.mxb.app.utils.dotsindicator
...
abstract class BaseDotsIndicator @JvmOverloads constructor(
    ...
    enum class Type(
        ...
        @param:StyleableRes val styleableId: IntArray,
        @param:StyleableRes val dotsColorId: Int,
        @param:StyleableRes val dotsSizeId: Int,
        @param:StyleableRes val dotsSpacingId: Int,
        @param:StyleableRes val dotsCornerRadiusId: Int,
        @param:StyleableRes val dotsClickableId: Int
    ) {
        DEFAULT(
            16f,
            8f,
